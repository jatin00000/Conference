      ...
      <div className="r9">
        <div className="r7">
          <div className="container">
            ...
            <table className="   border-primary"><div className="p-3 mb-2 r4  "><div className="fs-2 r3 text-left ">Train to Bihta Station</div> Bihta station is on Patna-Delhi’s main railway line. There are many trains (local/express) that stop at Bihta. From Bihta station, you can board an autorickshaw to reach IIT Patna. The fare for shared-auto is ₹ 10.00-20.00 and for reserve, the fare would be around ₹ 100.00-150.00 depending upon the time.
