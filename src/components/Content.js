...
<br></br>
      ...
      <div className="back1"><div className="container"><div className="he1 text-center p-2 fs-3">Agro-processing Startup Meet</div>
        <div className=" he2 p-2 fs-5">
          Startups play a major role in the translation of research for the benefit of general public. The startup ecosystem is also an overlooked career opportunity for research scholars in India. Hosting a startup session along with the technical conference aims at bridging the gap between research and startups. While startups can benefit from the recent technological developments, researchers can secure an opportunity to work closely on translating their knowledge base for commercializable outputs.
      ...
      <div className="back2"><div className="container"><div className="he1 text-center p-2 fs-3"><br></br>Research Photography Competition</div>
        <div className=" he2 p-2 fs-5">
          The event will also include a research photography competition. Images related to research, taken with microscope or normal camera may be submitted through the website. Submissions may include experimental setups, laboratories, equipment, microscopic images, etc. The photographs need not be directly related to the theme of the conference. Only original images taken by the competitors who retains the copyright of the image will be considered for the competition. Details of the competition will be updated soon.
<br></br>
<br></br>
      ...
      <div className="back1"><div className="container"><div className="he1 text-center p-2 fs-3">IIT Patna</div>
        <div className="he2 p-2 fs-5">
          IIT Patna is a premier educational and research institute in India that was established on 6th August 2008. Currently, IIT Patna has six engineering departments, three science departments, and a humanities and social science department. There are over three thousand five hundred students and over three fifty staff and faculty members on the campus. The institute routinely hosts several international and national seminars, conferences, and other technical meetings to promote research in various fields.
...
For more details about the institute, please visit the institute website <a target="_blank" rel="noopener noreferrer" href="https://www.iitp.ac.in/" className="link-dark">here</a>.
      ...
      <div className="back2"><div className="container"><div className="he1 text-center p-2 fs-3"><br></br>About Chemical and Biochemical Engineering Department</div>
        <div className="he2 p-2 fs-5">
          The Chemical and Biochemical Engineering or the CBE department of IITP was instated in the year 2014. The department presently offers Bachelor of Technology, Master of Technology by Research, and Doctor of Philosophy degrees in Chemical Engineering. These programs aim to develop highly-qualified, self-motivated graduates who are independent and open-minded individuals capable of contributing to industry, academia, and research and development programs.
Currently, the department has 8 faculty members at present who are eager to contribute innovative solutions to meet societal needs. The department has established well-equipped laboratories for teaching and research purposes. The facilities in the department are focused on experiments and simulations applicable to various sectors like energy, specialty chemicals, materials, and waste management. Over 20 Ph.D. research scholars, 180 UG students, and around 100 alumni are proud members of the department. For more details, please <a href="https://www.iitp.ac.in/index.php/departments/engineering-technology/chemical-and-biochemical-engineering" target="_blank" rel="noopener noreferrer" className="link-dark">Click here.</a><br></br><br></br>
        </div></div></div>
